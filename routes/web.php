...
Route::group(['middleware' => ['admin'], 'prefix' => 'admin'], function () {
    ...
    Route::prefix('total-data')->group(function () {
        Route::get('/', [DataController::class, 'total'])->name('admin.total-data'); // total data
    });

    Route::prefix('fresh-data')->group(function () {
        Route::get('/', [DataController::class, 'fresh'])->name('admin.fresh-data'); // fresh data
        // import excel
        Route::post('/import', [DataController::class, 'import'])->name('admin.fresh-data.import');
        // export excel
        Route::get('/export', [DataController::class, 'export'])->name('admin.fresh-data.export');
    });
});
